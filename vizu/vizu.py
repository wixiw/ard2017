...
class VizuMainScreen(QWidget):
    ...
    def __init__(self, clipboard):
        ...
        self.tabContexts["Robot"].tab.tab["Actuators"].sections["funny"].actCmd               .connect(self.teleop.requestActuatorsCmd)
        self.tabContexts["Robot"].tab.tab["Actuators"].sections["funny"].actCmd               .connect(self.teleop.requestActuatorsCmd)
        ...
        self.tabContexts["Robot"].tab.tab["Servos"].requestRotatorTurn                        .connect(self.teleop.requestRotatorTurn)
