...
{
  I2C_0.beginTransmission(TCS34725_ADDRESS);
  #if ARDUINO >= 100
  I2C_0.write(TCS34725_COMMAND_BIT | reg);
  I2C_0.write(value & 0xFF);
  #else
  I2C_0.send(TCS34725_COMMAND_BIT | reg);
  I2C_0.send(value & 0xFF);
  #endif
...
uint8_t Adafruit_TCS34725::read8(uint8_t reg)
{
  ...
  I2C_0.requestFrom(TCS34725_ADDRESS, 1);
  #if ARDUINO >= 100
  return I2C_0.read();
  #else
  return I2C_0.receive();
  #endif
}
...
uint16_t Adafruit_TCS34725::read16(uint8_t reg)
{
  ...
  I2C_0.requestFrom(TCS34725_ADDRESS, 2);
  #if ARDUINO >= 100
  t = I2C_0.read();
  x = I2C_0.read();
  #else
...
void Adafruit_TCS34725::clearInterrupt(void) {
  I2C_0.beginTransmission(TCS34725_ADDRESS);
  #if ARDUINO >= 100
  I2C_0.write(TCS34725_COMMAND_BIT | 0x66);
  #else
  I2C_0.send(TCS34725_COMMAND_BIT | 0x66);
  #endif
  I2C_0.endTransmission();
}
