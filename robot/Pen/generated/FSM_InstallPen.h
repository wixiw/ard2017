...
#ifndef FSM_INSTALLPEN_H_
#define FSM_INSTALLPEN_H_

#include "..\..\Common\1_RSP\core\sc_types.h"
#include "StatemachineInterface.h"
#include "..\..\Common\1_RSP\core\TimedStatemachineInterface.h"

/*! \file Header of the state machine 'FSM_InstallPen'.
*/

class FSM_InstallPen : public TimedStatemachineInterface, public StatemachineInterface
{
	...
	public:
		...
		*/
		...
		sc_boolean isStateActive(FSM_InstallPenStates state);
	...
	private:
		...
		FSM_InstallPenStates stateConfVector[maxOrthogonalStates];
...
inline FSM_InstallPen::DefaultSCI_OCB::~DefaultSCI_OCB() {}
#endif /* FSM_INSTALLPEN_H_ */
