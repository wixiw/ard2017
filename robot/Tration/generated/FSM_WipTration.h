...
#ifndef FSM_WIPTRATION_H_
#define FSM_WIPTRATION_H_

#include "..\..\Common\1_RSP\core\sc_types.h"
#include "StatemachineInterface.h"
#include "..\..\Common\1_RSP\core\TimedStatemachineInterface.h"

/*! \file Header of the state machine 'FSM_WipTration'.
*/

class FSM_WipTration : public TimedStatemachineInterface, public StatemachineInterface
{
	...
	public:
		...
		*/
		...
		sc_boolean isStateActive(FSM_WipTrationStates state);
	...
	private:
		...
		FSM_WipTrationStates stateConfVector[maxOrthogonalStates];
...
inline FSM_WipTration::DefaultSCI_OCB::~DefaultSCI_OCB() {}
#endif /* FSM_WIPTRATION_H_ */
