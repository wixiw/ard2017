...
#ifndef FSM_HOMOLTRATION_H_
#define FSM_HOMOLTRATION_H_

#include "..\..\Common\1_RSP\core\sc_types.h"
#include "StatemachineInterface.h"
#include "..\..\Common\1_RSP\core\TimedStatemachineInterface.h"

/*! \file Header of the state machine 'FSM_HomolTration'.
*/

class FSM_HomolTration : public TimedStatemachineInterface, public StatemachineInterface
{
	...
	public:
		...
		typedef enum
		{
			main_region_Escaping_from_Start_area___Goto_Thru_D,
			main_region_Go_To_Dispenser_G,
			main_region_Goto_Thru_E,
		...
		*/
		...
		sc_boolean isStateActive(FSM_HomolTrationStates state);
	...
	private:
		...
		FSM_HomolTrationStates stateConfVector[maxOrthogonalStates];
		...
		sc_boolean check_main_region_Escaping_from_Start_area___Goto_Thru_D_tr0_tr0();
		...
		void exseq_main_region_Goto_Thru_E();
		...
		void react_main_region_Goto_Thru_E();
...
inline FSM_HomolTration::DefaultSCI_OCB::~DefaultSCI_OCB() {}
#endif /* FSM_HOMOLTRATION_H_ */
