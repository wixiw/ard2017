...
#ifndef FSM_INSTALLTRATION_H_
#define FSM_INSTALLTRATION_H_

#include "..\..\Common\1_RSP\core\sc_types.h"
#include "StatemachineInterface.h"
#include "..\..\Common\1_RSP\core\TimedStatemachineInterface.h"

/*! \file Header of the state machine 'FSM_InstallTration'.
*/

class FSM_InstallTration : public TimedStatemachineInterface, public StatemachineInterface
{
	...
	public:
		...
		{
			main_region_StateA,
			FSM_InstallTration_last_state
		} FSM_InstallTrationStates;
		...
		class DefaultSCI
		{
			...
			private:
				friend class FSM_InstallTration;
		};
		...
		*/
		...
		sc_boolean isStateActive(FSM_InstallTrationStates state);
	...
	private:
		...
		FSM_InstallTrationStates stateConfVector[maxOrthogonalStates];
...
inline FSM_InstallTration::DefaultSCI_OCB::~DefaultSCI_OCB() {}
#endif /* FSM_INSTALLTRATION_H_ */
